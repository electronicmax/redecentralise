...
While these platforms may be connected to and through the Web, they are, in many ways, antithetical to the original spirit of the Web; instead of providing open, standard interfaces for global interoperability, these ecosystems have become increasingly closed to third-party developers.  Moreover, intead of granting the ability for end-users of services to easily interoperate with multiple platforms and to exchange data among them, they have, through legal or technical means, sought to control what data leaves them, supporting only efforts to centralise more data around them. 
