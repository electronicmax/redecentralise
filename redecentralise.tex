...
The Web was designed as a decentralised system to make it easy for individuals to independently share and access information with each other, simply by running a web server and using a browser.  It has revolutionised the ways people share and access information, creating entirely new industries and economies of information sharing.  These industries have, in turn, been driven by a huge variety of sharing-rich applications and services that both people and businesses now rely on across many aspects of their daily operations.  
...
In response, there has been a growing initiative among makers and hackers to try to `re-decentralise' the web, that is allow end-users to rely less on such brokers, and retain greater control over their data.  There remains, however, little consensus among this movement on how to achieve such a goal; re-decentralisation projects address issues as varied as anonymised routing, to distributed cryptocurrencies and secure filesharing.

In this paper, we argue that the way forward is re-decentralise the web is to keep it the Web -- addressing only the obstacles that make it difficult for end-users to act as information controllers. While this may seem an obvious statement, many of the thus far proposed approaches have advocated fundamental changes to the protocols and architectures of the Web.  Yet, what such architectures lack is the flexibility and generality that continues to make the Web not only the primary platform of choice for deploying apps and services, and also which benefits from the collective contributions of millions of developers publishing common libraries and tools, thanks to the open standards that underlie it.  
